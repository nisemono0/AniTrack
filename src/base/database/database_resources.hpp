...
inline const QString SelectAllMedia        = QStringLiteral(":/database/SelectAllMedia");
inline const QString SelectAnimeByMediaIds = QStringLiteral(":/database/SelectAnimeByMediaIds");
} // namespace DatabaseResource
